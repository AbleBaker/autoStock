...
//     	listOfAdjustmentBase.add(new AdjustmentOfBasicInteger("Period length", algorithmBase.signalGroup.signalOfCCI.signalParameters.periodLength, new IterableOfInteger(20, 60, 1)));
     	...
     	listOfAdjustmentBase.add(new AdjustmentOfBasicInteger("Upper bounds", ((SignalParametersForUO)algorithmBase.signalGroup.signalOfUO.signalParameters).upperBounds, new IterableOfInteger(0, 20, 1)));
     	listOfAdjustmentBase.add(new AdjustmentOfBasicInteger("Lower bounds", ((SignalParametersForUO)algorithmBase.signalGroup.signalOfUO.signalParameters).lowerBounds, new IterableOfInteger(-20, 0, 1)));
