...
public class IndicatorOfSMA extends IndicatorBase {
	...
	public IndicatorOfSMA(ImmutableInteger periodLength,  int resultsetLength, CommonAnalysisData commonAnlaysisData, Core taLibCore, SignalMetricType signalMetricType) {
