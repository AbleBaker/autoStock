...
public class MenuLauncher {
	public void launchDisplay(MenuStructures menuStructure){
		if (menuStructure == MenuStructures.menu_request_historical_prices){
			...
			switch (menuCommand){
				case "1" :
					command = "main_backtest 01/03/2012 01/05/2012 NYSE AIG backtest_adjustment_individual";
					break;
				case "2" :
					command = "main_backtest 01/03/2012 01/05/2012 NYSE AIG backtest_default";
					break;
				case "3" :
					command = "main_backtest 03/06/2012 03/06/2012 NYSE AIG backtest_default";
					break;
				case "4":
					command = "main_clustered_backtest 01/03/2012 01/05/2012 NYSE \"AIG\"";
					break;
				case "5":
