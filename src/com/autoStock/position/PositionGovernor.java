...
import com.autoStock.signal.SignalPointTacticResolver;
...
public class PositionGovernor {
	...
	public PositionGovernorResponse informGovener(QuoteSlice quoteSlice, Signal signal, Exchange exchange, StrategyOptions strategyOptions, boolean requestExit, Position position, PositionOptions positionOptions, BasicAccount basicAccount){
		...
		if (position == null){
			signalPoint = SignalPointTacticResolver.getSignalPoint(false, signal, PositionType.position_none, strategyOptions.signalPointTacticForEntry.value);
			...
			signalPoint = SignalPointTacticResolver.getSignalPoint(true, signal, position.positionType, strategyOptions.signalPointTacticForExit.value);
