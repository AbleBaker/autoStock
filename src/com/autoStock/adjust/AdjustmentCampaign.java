...
//		listOfAdjustmentBase.add(new AdjustmentOfEnum("CCI Guage Entry", new IterableOfEnum<SignalGuageType>(SignalGuageType.values()[0]), SignalDefinitions.SignalMetricType.metric_adx.arrayOfSignalGuageForLongEntry[0].immutableEnumForSignalGuageType));
//		listOfAdjustmentBase.add(new AdjustmentOfEnum("CCI Guage Exit", new IterableOfEnum<SignalGuageType>(SignalGuageType.values()[0]), SignalDefinitions.SignalMetricType.metric_adx.arrayOfSignalGuageForLongExit[0].immutableEnumForSignalGuageType));
//		
