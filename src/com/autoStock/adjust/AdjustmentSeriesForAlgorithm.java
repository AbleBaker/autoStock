...
//		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(algorithmBase.signalGroup.signalOfUO, AdjustmentType.signal_metric_long_entry, new IterableOfInteger(-30, 30, 5, false)));
//		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(algorithmBase.signalGroup.signalOfUO, AdjustmentType.signal_metric_long_exit, new IterableOfInteger(-30, 30, 5, false)));
//		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(algorithmBase.signalGroup.signalOfUO, AdjustmentType.signal_metric_short_entry, new IterableOfInteger(-30, 30, 5, false)));
//		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(algorithmBase.signalGroup.signalOfUO, AdjustmentType.signal_metric_short_exit, new IterableOfInteger(-30, 30, 5, false)));
...
//		Co.println("--> Check: " + algorithmBase.signalGroup.signalOfCCI.signalParameters.periodLength.toString());
	...
	private void addTypicalSignalRange(SignalBase signalBase){
		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(signalBase, AdjustmentType.signal_metric_long_entry, new IterableOfInteger(-30, 30, 2, false)));
		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(signalBase, AdjustmentType.signal_metric_long_exit, new IterableOfInteger(-30, 30, 2, false)));
		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(signalBase, AdjustmentType.signal_metric_short_entry, new IterableOfInteger(-30, 30, 2, false)));
		listOfAdjustmentBase.add(new AdjustmentOfSignalMetric(signalBase, AdjustmentType.signal_metric_short_exit, new IterableOfInteger(-30, 30, 2, false)));
	}
}
