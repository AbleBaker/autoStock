...
//		listOfAdjustmentBase.add(new AdjustmentOfBasicDouble("maxStopLossPercent", algorithmBase.strategyBase.strategyOptions.maxStopLossPercent, new IterableOfDouble(1, 10, 0.1)));
