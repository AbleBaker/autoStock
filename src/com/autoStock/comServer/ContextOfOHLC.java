...
//		Co.println("\n");
		...
		EncogSubframe subframe1 = new EncogSubframe(getClass().getSimpleName(), ListTools.subList(MathTools.getDeltasAsPercent(listOfClose), 1, -1), FrameType.raw, 1, -1);
		encogFrame.addSubframe(subframe1);
		
		EncogSubframe subframe2 = new EncogSubframe(getClass().getSimpleName(), listOfCO, FrameType.raw, 1, -1);
