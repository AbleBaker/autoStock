...
public class TableDefinitions {
	public static enum AsciiTables{
		...
		backtest_strategy_response(new AsciiColumns[]{AsciiColumns.dateTime, AsciiColumns.symbol, AsciiColumns.price, AsciiColumns.strategyResponse, AsciiColumns.positionGovernorResponse, AsciiColumns.signal, AsciiColumns.transactionDetails, AsciiColumns.profitLoss}),
		;
