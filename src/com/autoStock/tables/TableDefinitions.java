...
public class TableDefinitions {
	public static enum AsciiTables{
		...
		algorithm_manager(new AsciiColumns[]{AsciiColumns.dateTime, AsciiColumns.symbol, AsciiColumns.signal, AsciiColumns.position, AsciiColumns.price, AsciiColumns.priceClose, AsciiColumns.percentChange, AsciiColumns.percentChange, AsciiColumns.transactionDetails}),
		backtest_strategy_response(new AsciiColumns[]{AsciiColumns.dateTime, AsciiColumns.symbol, AsciiColumns.price, AsciiColumns.strategyResponse, AsciiColumns.positionGovernorResponse, AsciiColumns.signal}),
		;
